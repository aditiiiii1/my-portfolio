          ...
          <div className={containerClass}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {Object.entries(skills).map(([category, skillList]) => (
                <div
                  key={category}
                  className="bg-[#f5f5dc] border-2 border-[#d11979]/30 p-6 rounded-xl shadow-lg"
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {skillList.map((skill, index) => (
                      <span
                        key={index}
                        className="bg-[#d11979]/10 text-gray-800 text-sm font-medium px-4 py-2 rounded-full border border-[#d11979]/20"
                      >
                        {skill}
                      </span>
                    ))}
